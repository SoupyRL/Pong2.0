'Fichier Pong2.0_fr.sln
'Programmation Visual Basic
'écrit par Duncan Campbell
'Créer le 17/05/12
'Dernier modification le 17/06/1

REM Pong contre un A.I qui  ou contre un ami(e) 
    ...
    Public Sub tmrJoue_Tick(sender As Object, e As EventArgs) Handles tmrJoue.Tick
        ...
        ElseIf picBall.Location.X < -50 Then
            ...
            If btePoint2 = 15 Then
                ...
                If bteAI = 1 Then
                    lblFinit.Text = "T'AS PERDU!"                                                                                               'Message de perde contre le CPU
                ...
                ElseIf bteAI = 0 Then
                    lblFinit.Text = strJoueur2 & " GAGNE"                                                                                      'Message de gagner pour la deuxième joueur
        ...
        ElseIf picBall.Location.X > 900 Then
            ...
            If btePoint1 = 15 Then
                ...
                If bteAI = 1 Then
                    lblFinit.Text = "VOUS GAGNE!"                                                                                              'Message de gagner contre le CPU
                    lblFinit.ForeColor = Color.Lime                                                                                         'Change la couleur de text à verte
                ...
                ElseIf bteAI = 0 Then
                    lblFinit.Text = strJoueur1 + " GAGNE"                                                                                    'Message de gagner pour Joueur 1
                    lblFinit.ForeColor = Color.Lime                                                                                         'Change la couleur de text à verte
                    lblFinit.Location = New Point((Me.Width / 2) - (lblFinit.Width / 2), (Me.Height / 2) - (lblFinit.Height / 2 + 50))      'Met la message de gagner au centre du terrain
...
#Region "Bouton Démarreur aléatoire"
    ...
    Private Sub tmrAI_Tick(sender As Object, e As EventArgs) Handles tmrAI.Tick
        If (bteAI = 1) Then
            ...
            ElseIf btePoint1 - btePoint2 <= 0 Then
                matriceDifficulty1(0) = 1
            ElseIf btePoint1 = 1 Then
                matriceDifficulty1(0) = 2
            ElseIf btePoint1 = 2 Then
                matriceDifficulty1(0) = 3
            ElseIf btePoint1 = 3 Then
                matriceDifficulty1(0) = 4
            ElseIf btePoint1 = 4 Then
                matriceDifficulty1(0) = 5
            ElseIf btePoint1 = 5 Then
                matriceDifficulty1(0) = 6
            ElseIf btePoint1 = 6 Then
                matriceDifficulty1(0) = 7
            ElseIf btePoint1 = 7 Then
                matriceDifficulty1(0) = 8
            ElseIf btePoint1 = 8 Then
                matriceDifficulty1(0) = 9
            ElseIf btePoint1 = 9 Then
                matriceDifficulty1(0) = 10
            ElseIf btePoint1 = 10 Then
                matriceDifficulty1(0) = 11
            ElseIf btePoint1 = 11 Then
                matriceDifficulty1(0) = 12
            ElseIf btePoint1 = 12 Then
                matriceDifficulty1(0) = 13
            ElseIf btePoint1 = 13 Then
                matriceDifficulty1(0) = 14
            ElseIf btePoint1 = 14 Then
            ...
            If picBall.Location.Y > 1 And picBall.Location.Y <= Me.Height - 45 And coordBallon.X > 375 Then
